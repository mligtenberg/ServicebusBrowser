...
export class AppModule { 
  constructor() {
    const servicebus = document.createElement("script");
    servicebus.type = "text/javascript";
    servicebus.async = true;
    servicebus.src = "/assets/servicebus.js";
    document.head.append(servicebus);
 }
}
