...
export class ViewMessagesComponent implements OnInit, OnDestroy {
    ...
    constructor(private store: Store<State>, private activeRoute: ActivatedRoute, private router: Router) {}
    ...
    ngOnInit(): void {
        this.subs.add(
            this.activeRoute.params.subscribe((params) => {
                ...
                this.activePageSubscription = this.store.select(getMessages(params.messageSetId)).subscribe((messageSet) => {
                    if (!messageSet) {
