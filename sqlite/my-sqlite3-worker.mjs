  ...
  Module.runSQLite3PostLoadInit = async function (
    ...
    globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(
      ...
      Object.assign(wasm, {
        ...
        pointerSize:
          'number' === typeof config.exports.sqlite3_libversion() ? 4 : 8,
    ...
    globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
      ...
      xArg.FuncPtrAdapter = class FuncPtrAdapter extends AbstractArgAdapter {
        constructor(opt) {
          ...
          this.callProxy =
            opt.callProxy instanceof Function ? opt.callProxy : void 0;
        }
    ...
    globalThis.Jaccwabyt = function StructBinderFactory(config) {
      ...
      const ptrIR =
        config.pointerIR || config.ptrIR || (4 === ptrSize ? 'i32' : 'i64');
      if (ptr) {
        dealloc(ptr);
        ptr = void 0;
      }
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      const dbCtorHelper = function ctor(...args) {
        ...
        this.createFunction({
          name: 'regexp',
          deterministic: true,
          xFunc: (context, pattern, value) => {
            // SQLite may pass NULLs as `null`
            if (pattern == null || value == null) return 0;
            try {
              return new RegExp(String(pattern)).test(String(value)) ? 1 : 0;
            } catch {
              // invalid regex -> treat as no match (or throw if you prefer)
              return 0;
            }
          },
        });
      ...
      sqlite3.initWorker1API = function () {
        ...
        const wState = {
          ...
          getDb: function (id, require = true) {
            return (
              this.dbs[id] ||
              (require ? toss('Unknown (or closed) DB ID:', id) : void 0)
            );
          },
        };
        ...
        return new Promise(function (promiseResolve_, promiseReject_) {
          ...
          const vfsSyncWrappers = {
            ...
            xCurrentTime: function (pVfs, pOut) {
              wasm.poke(
                pOut,
                2440587.5 + /* @__PURE__ */ new Date().getTime() / 864e5,
                'double',
              );
              return 0;
            },
            xCurrentTimeInt64: function (pVfs, pOut) {
              wasm.poke(
                pOut,
                2440587.5 * 864e5 + /* @__PURE__ */ new Date().getTime(),
                'i64',
              );
              return 0;
            },
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      const ioMethods = {
        ...
        xFileSize: function (pFile, pSz64) {
          ...
          pool.log(`xFileSize`);
          const size =
            pool.getOFileForS3File(pFile).sah.getSize() - HEADER_OFFSET_DATA;
